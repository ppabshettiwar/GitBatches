			...
			return {
				...
				link: function (scope, $el) {
					var el = $el[0],
						...
						sortable
					;
					if(!options.baseIndex) options.baseIndex = 0;
					...
					function _emitEvent(/**Event*/evt, /*Mixed*/item) {
						...
						options[name] && options[name]({
							...
							models: source,
							oldIndex: evt.oldIndex - options.baseIndex,
							newIndex: evt.newIndex - options.baseIndex
						});
					}
					...
					function _sync(/**Event*/evt) {
						...
						var oldIndex = evt.oldIndex - ((evt.type == 'update') ? options.baseIndex : 0),
							newIndex = evt.newIndex - ((evt.type == 'add' || evt.type == 'update') ? options.baseIndex : 0);
